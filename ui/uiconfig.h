...
#define SIXDOF_NOT_BEGIN_X_OUT_OF_RANGE_MESSAGE      "纵向幅值超限，不能开始"
#define SIXDOF_NOT_BEGIN_Y_OUT_OF_RANGE_MESSAGE      "横向幅值超限，不能开始"
#define SIXDOF_NOT_BEGIN_Z_OUT_OF_RANGE_MESSAGE      "垂向幅值超限，不能开始"
#define SIXDOF_NOT_BEGIN_ROLL_OUT_OF_RANGE_MESSAGE   "侧倾幅值超限，不能开始"
#define SIXDOF_NOT_BEGIN_PITCH_OUT_OF_RANGE_MESSAGE  "俯仰幅值超限，不能开始"
#define SIXDOF_NOT_BEGIN_YAW_OUT_OF_RANGE_MESSAGE    "航向幅值超限，不能开始"

#define SIXDOF_NOT_BEGIN_XYZ_SPEED_OUT_OF_RANGE_MESSAGE    "线运动线速度超限，不能开始"
#define SIXDOF_NOT_BEGIN_DEG_SPEED_OUT_OF_RANGE_MESSAGE    "角运动角速度超限，不能开始"
#define SIXDOF_NOT_BEGIN_XYZ_ACC_OUT_OF_RANGE_MESSAGE      "线运动加速度超限，不能开始"
#define SIXDOF_NOT_BEGIN_DEG_ACC_OUT_OF_RANGE_MESSAGE      "角运动加速度超限，不能开始"
